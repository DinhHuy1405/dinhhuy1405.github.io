...
const PageHead: React.FC<{
    ...
    return (
        <>
            ...
            <meta name="keywords" content="portfolio, AI Engineer, Full Stack Data Engineer" />
            <meta name="author" content="Nguyễn Đình Huy" />
            <meta property="og:type" content="website" />
            <meta property="og:image" content="/img/favicon.png" />
            <meta
                property="og:description"
                content="Nguyễn Đình Huy - a Full Stack Data Engineer and AI Engineer. Experience in data analyzing, AI & ML."
            />
