...
export const deals: Deal[] = [
    {
        ...
        code: "HUYTIM50",
        description: "Note-taking app with PDF markup, AI tools and flashcards. Use my code at checkout.",
    },
    {
        name: "Kalodata",
        ...
        code: "HUYTIM2000",
        description: "TikTok Shop analytics and insights. Use my code at checkout.",
    },
];
